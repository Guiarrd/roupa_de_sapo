...
public class LogController {
    ...
    @GetMapping(value="/filterOrderBy", params = "order") // acessar /log/filter?level=LEVEL via GET para listar os logs ordenados pelo nível especificado
    ...
    @GetMapping(value="/filterByEnvironmentOrderBy", params = {"env","order"}) // acessar /log/filter?env=ENVIRONMENT&level=LEVEL via GET para listar os logs que pertencem ao ambiente especificado, ordenados pelo nível especificado
